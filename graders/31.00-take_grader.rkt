...
(@test "take#1" "err" (take empty 0) empty 1)
(@test "take#2" "err" (take (list 8 7) 5) (list 8 7) 1)
(@test "take#3" "err" (take (list 4 9 2 7) 3) (list 4 9 2) 1)
