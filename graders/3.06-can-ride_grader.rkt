...
(define ASSIGNMENT-NAME 'can-ride)
...
(check: :language 'lang/htdp-intermediate
        ...
        (!procedure can-ride? 2)

        ; MAX SCORE SHOULD BE (N / TOTAL-UNIT-TESTS)
        (set-test-max-score! 6)

(@test "1" "err" (can-ride? 13 #true) #true 1)
(@test "2" "err" (can-ride? 13 #false) #true 1)
(@test "3" "err" (can-ride? 12 #true) #true 1)
(@test "4" "err" (can-ride? 12 #false) #true 1)
(@test "5" "err" (can-ride? 11 #false) #false 1)
(@test "6" "err" (can-ride? 11 #true) #true 1)
