...
(@test "zip#1" "err" (zip empty empty) empty 1)
(@test "zip#2" "err" (zip (list 2 4 9) (list 7 3 0)) ((submission-eval) '(list (make-entry 2 7) (make-entry 4 3) (make-entry 9 0))) 1)
        )
(post:
 (add-score-to-report!)
 (write-report)
