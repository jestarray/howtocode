...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 4.4-formalize_starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|
...
Design a function that will capitalize the first letter of a sentence
|#
