...
(@test "snoc#1" "err" (snoc 3 empty) (cons 3 empty) 1)
(@test "snoc#2" "err" (snoc 3 (cons 1 (cons 2 empty))) (cons 1 (cons 2 (cons 3 empty))) 1)
(@test "snoc#3" "err" (snoc 4 (cons 2 (cons 1 empty))) (cons 2 (cons 1 (cons 4 empty))) 1)
