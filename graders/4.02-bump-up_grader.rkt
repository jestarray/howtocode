...
(define ASSIGNMENT-NAME 'bump-up)
...
(@test "1" "err" (bump-up "A") "A" 1)
(@test "2" "err" (bump-up "B") "A" 1)
(@test "3" "err" (bump-up "C") "B" 1)
(@test "4" "err" (bump-up "D") "C" 1)
(@test "5" "err" (bump-up "F") "D" 1)
        ; (println submission)
        )
(post:
 (add-score-to-report!)
