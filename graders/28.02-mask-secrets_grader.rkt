...
(define ASSIGNMENT-NAME 'mask-secrets)
...
(@test "mask-secrets#1" "err" (mask-secrets empty empty) empty 1)
(@test "mask-secrets#2" "err" (mask-secrets (list "foo") empty) (list "foo") 1)
(@test "mask-secrets#3" "err" (mask-secrets empty (list "foo")) empty 1)
(@test "mask-secrets#4" "err" (mask-secrets (list "foo") (list "foo"))  (list "REDACTED") 1)
(@test "mask-secrets#5" "err" (mask-secrets (list "operation" "snake" "eater" "mission") (list "snake" "eater"))  (list "operation" "REDACTED" "REDACTED" "mission") 1)
