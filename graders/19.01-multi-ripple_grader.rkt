...
(define ASSIGNMENT-NAME 'multi-ripple)
...
(check: :language 'lang/htdp-intermediate
        ...
        (!procedure grow-all-ripple 1)

        ; MAX SCORE SHOULD BE (N / TOTAL-UNIT-TESTS)
        (set-test-max-score! 1)

(@test "grow-all-ripple" "err" (grow-all-ripple empty) empty 1)
; ripple growth rate could be different?
