...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname buggy_logic4_solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
