...
(define ASSIGNMENT-NAME 'update-equip)
...
(check: :language 'lang/htdp-intermediate
        ...
        (!procedure update-equip 2)

        ; MAX SCORE SHOULD BE (N / TOTAL-UNIT-TESTS)
        (set-test-max-score! 4)

(@test "update-equip#1" "err" (update-equip (make-player "Harry" (make-wep "Wand" "Mage" 20)) (make-wep "Wizards Staff" "Mage" 50)) ((submission-eval) '(make-player "Harry" (make-wep "Wizards Staff" "Mage" 50))) 1)
(@test "update-equip#2" "err" (update-equip (make-player "Harry" (make-wep "Wand" "Mage" 20)) (make-wep "Sword" "Knight" 10)) ((submission-eval) '(make-player "Harry" wand)) 1)
(@test "update-equip#3" "err" (update-equip (make-player "Jack" (make-wep "Sword" "Knight" 10)) (make-wep "Sword" "Knight" 10)) ((submission-eval) '(make-player "Jack" (make-wep "Sword" "Knight" 10))) 1)
        ; (println submission)
        )
(post:
 (add-score-to-report!)
