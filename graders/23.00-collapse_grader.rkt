...
(define ASSIGNMENT-NAME 'collapse)
...
(check: :language 'lang/htdp-intermediate-lambda
        ...
        (!procedure collapse 3)

        ; MAX SCORE SHOULD BE (N / TOTAL-UNIT-TESTS)
        (set-test-max-score! 3)

(@test "collapse#1" "err" (collapse + 0 empty) 0 1)
(@test "collapse#2" "err" (collapse + 0 (list 4 6)) 10 1)
(@test "collapse#3" "err" (collapse * 1 (list 4 6)) 24 1)
