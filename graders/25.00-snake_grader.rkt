...
(@test "update-snake#1-normal-move" "err"
       (update-snake (list (make-point 4 5) (make-point 3 5))
                     (make-point 0 1)
                     (make-point 2 4))
       ((submission-eval)
        '(list (make-point 4 6)
...
(@test "ate-self?#0" "err" (ate-self? (list (make-point 4 4) (make-point 5 4) (make-point 5 3) (make-point 4 4))) #true 1)
(@test "ate-self?#1" "err" (ate-self? (list (make-point 4 4) (make-point 5 4))) #false 1)
        ; (println submission)
        )
(post:
 (add-score-to-report!)
