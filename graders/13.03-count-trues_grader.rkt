...
(define ASSIGNMENT-NAME 'count-trues)
...
(check: :language 'lang/htdp-intermediate
        ...
        (!procedure count-trues 1)

        ; MAX SCORE SHOULD BE (N / TOTAL-UNIT-TESTS)
        (set-test-max-score! 3)


(@test "count-trues#1" "err" (count-trues empty) 0 1)
(@test "count-trues#2" "err" (count-trues (cons #true empty)) 1 1)
(@test "count-trues#3" "err" (count-trues (cons #false (cons #true (cons #true empty)))) 2 1)
