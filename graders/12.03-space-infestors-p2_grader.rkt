...
(define ASSIGNMENT-NAME 'space-infestors-p2)
...
(check: :language 'lang/htdp-intermediate
        ...
        (!procedure update-tank 1)
        (!procedure update-menemy 1)
        (!procedure update-mbullet 1)
...
; omitted updated structure of speed test because it might depend on clients
(@test "update-menemy" "err" (update-menemy #false) #false 1) 
(@test "update-mbullet" "err" (update-mbullet #false) #false 1)
