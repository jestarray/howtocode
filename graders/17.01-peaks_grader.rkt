...
(@test "peaks#1" "err" (peaks empty) empty 1)
(@test "peaks#2" "err" (peaks (cons 2 empty)) (cons 2 empty) 1)
(@test "peaks#3" "err" (peaks (cons 1 (cons 6 (cons 4 (cons 5 empty))))) (cons 6 (cons 5 empty)) 1)
