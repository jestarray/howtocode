...
(@test "1" "err" (double-all empty) empty 1)
(@test "2" "err" (double-all (cons 2 empty)) (cons (* 2 2) empty) 1)
(@test "3" "err" (double-all (cons 2 (cons 5 empty))) (cons (* 2 2) (cons (* 2 5) empty)) 1)
