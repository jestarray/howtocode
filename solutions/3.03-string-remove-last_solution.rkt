...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 5.3-string-remove-last_solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
