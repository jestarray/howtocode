...
(define ASSIGNMENT-NAME 'year-month-day->date)
...
(check: :language 'lang/htdp-intermediate
        ...
        (!procedure year-month-day->date 5)

        ; MAX SCORE SHOULD BE (N / TOTAL-UNIT-TESTS)
        (set-test-max-score! 4)

(@test "1" "err" (year-month-day->date 1936 "November" 12 "MDY" "long" ) "November 12, 1936" 1)
(@test "2" "err" (year-month-day->date 1936 "November" 12 "MDY" "short") "Nov 12, 1936" 1)
(@test "3" "err" (year-month-day->date 1936 "November" 12 "DMY" "long" ) "12 November 1936" 1)
(@test "4" "err" (year-month-day->date 1936 "November" 12 "DMY" "short") "12 Nov 1936" 1)
