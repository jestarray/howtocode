...
(define ASSIGNMENT-NAME 'countdown-to-image)
...
(check: :language 'lang/htdp-intermediate
        ...
        (!procedure countdown-to-image 1)

        ; MAX SCORE SHOULD BE (N / TOTAL-UNIT-TESTS)
        (set-test-max-score! 3)

(@test "1" "err" (countdown-to-image #false) empty-image 1)
(@test "2" "err" (countdown-to-image 1) (text "1" 24 "blue") 1)
(@test "3" "image did not match!" (countdown-to-image "complete") (text "Happy New Years🎉!!!" 24 "red") 1)
        ; (println submission)
        )
(post:
 (add-score-to-report!)
