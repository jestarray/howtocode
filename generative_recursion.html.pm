...
◊h3{How do we combine the results of the trival case and potential sub problems to solve the overarching problem? Aka, the generative case!}
...
◊h3{How does it terminate?}
The given number(side-length) is getting / 2 at every step, therefore shrinking towards the ◊code{LIMIT}. 
