...
(define ASSIGNMENT-NAME 'curr-age)
...
(check: :language 'lang/htdp-intermediate
        ...
        (!procedure curr-age 2)

        ; MAX SCORE SHOULD BE (N / TOTAL-UNIT-TESTS)
        (set-test-max-score! 4)

(@test "curr-age#1" "err" (curr-age (make-person "bob" "smith" (make-date 12 25 2000)) (make-date 1 1 2025)) ((submission-eval) 24) 1)
(@test "curr-age#2" "err" (curr-age (make-person "bob" "smith" (make-date 12 25 2000)) (make-date 12 25 2025)) ((submission-eval) 25) 1)
(@test "curr-age#3" "err" (curr-age (make-person "bob" "smith" (make-date 12 25 2000)) (make-date 12 31 2025)) ((submission-eval) 25) 1)
(@test "curr-age#4" "err" (curr-age (make-person "bob" "smith" (make-date 12 25 2000)) (make-date 12 25 2000)) ((submission-eval) 0) 1)
        ; (println submission)
        )
(post:
 (add-score-to-report!)
