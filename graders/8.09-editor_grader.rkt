...
(@test "handle-key#1" "err" (handle-key (make-editor "hey" "guys") "\b") ((submission-eval) '(make-editor "he" "guys")) 1)
(@test "handle-key#2" "err" (handle-key (make-editor "hey guys" "") "left") ((submission-eval) '(make-editor "hey guy" "s")) 1)
(@test "handle-key#3" "err" (handle-key (make-editor "" "hey guys") "right") ((submission-eval) '(make-editor "h" "ey guys")) 1)
(@test "handle-key#4" "err" (handle-key (make-editor "hey" "guys") "z") ((submission-eval) '(make-editor "heyz" "guys")) 1)
(@test "handle-key#5" "err" (handle-key (make-editor "hey" "guys") "shift") ((submission-eval) '(make-editor "hey" "guys")) 1)
        ; (println submission)
        )
(post:
 (add-score-to-report!)
