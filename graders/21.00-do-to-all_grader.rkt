...
(define ASSIGNMENT-NAME 'do-to-all)
...
(check: :language 'lang/htdp-intermediate
        ...
        (!procedure do-to-all 2)

        ; MAX SCORE SHOULD BE (N / TOTAL-UNIT-TESTS)
        (set-test-max-score! 3)

(@test "do-to-all#1" "err" (do-to-all string-upcase empty) empty 1)
(@test "do-to-all#2" "err" (do-to-all string-upcase (list "a" "b")) (list "A" "B") 1)
