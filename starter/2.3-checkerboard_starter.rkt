...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 2.3-checkerboard_starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
