...
(@test "gcd-euclid#1" "err" (gcd-euclid 6 4) 2 1)
(@test "gcd-euclid#2" "err" (gcd-euclid 27 81) 27 1)
(@test "gcd-euclid#3" "err" (gcd-euclid 36 81) 9 1)
        )
(post:
 (add-score-to-report!)
 (write-report)
