...
(@test "drop#1" "err" (drop empty 0) empty 1)
(@test "drop#2" "err" (drop (list 7 9) 1) (list 9) 1)
(@test "drop#3" "err" (drop (list 7 9) 2) empty 1)
(@test "drop#4" "err" (drop (list 7 9) 10) empty 1)
(@test "drop#5" "err" (drop (list 4 9 2 7) 3) (list 7) 1)
