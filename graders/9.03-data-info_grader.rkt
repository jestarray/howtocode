...
(define ASSIGNMENT-NAME 'data-info)
...
(check: :language 'lang/htdp-intermediate
        ...
        (!procedure data-info 1)

        ; MAX SCORE SHOULD BE (N / TOTAL-UNIT-TESTS)
        (set-test-max-score! 2)

(@test "data-info#1" "err" (data-info (make-computer "HP" (make-storage 500 500))) "0 GB free of 500 GB" 1)
(@test "data-info#2" "err" (data-info (make-computer "DELL" (make-storage 50 500))) "450 GB free of 500 GB" 1)
