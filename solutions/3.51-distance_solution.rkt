...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 5.51-distance_solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
