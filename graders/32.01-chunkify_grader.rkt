...
(define ASSIGNMENT-NAME 'chunkify)
...
(@test "chunkify#1" "err" (chunkify empty 0) empty 1)
(@test "chunkify#2" "err" (chunkify empty 1) empty 1)
(@test "chunkify#3" "err" (chunkify (list 9 4) 1) (list (list 9) (list 4)) 1)
(@test "chunkify#4" "err" (chunkify (list 9 4) 2) (list (list 9 4)) 1)
(@test "chunkify#5" "err" (chunkify (list 7 0 9) 2) (list (list 7 0) (list 9)) 1)
