...
(define ASSIGNMENT-NAME 'contains-sublist)
...
(@test "contains-sublist?#1" "err" (contains-sublist? empty empty) #false 1)
(@test "contains-sublist?#2" "err" (contains-sublist? (list 1) empty) #false 1)
(@test "contains-sublist?#3" "err" (contains-sublist? empty (list 2)) #false 1)
(@test "contains-sublist?#4" "err" (contains-sublist? (list 2 ) (list 2)) #true 1)
(@test "contains-sublist?#5" "err" (contains-sublist? (list 8 6) (list 9 8 8 6 0)) #true 1)
(@test "contains-sublist?#6" "err" (contains-sublist? (list 9 8 8 6 0) (list 8 6)) #false 1)
(@test "contains-sublist?#7" "err" (contains-sublist? (list 8 6) (list 9 8 8 1 0)) #false 1)
