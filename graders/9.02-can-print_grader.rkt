...
(define ASSIGNMENT-NAME 'can-print)
...
(check: :language 'lang/htdp-intermediate
        ...
        (!procedure can-print? 1)

        ; MAX SCORE SHOULD BE (N / TOTAL-UNIT-TESTS)
        (set-test-max-score! 5)

(@test "can-print?#1" "err" (can-print? (make-printer "HP" 0 (make-ink 100 "black"))) ((submission-eval) ((submission-eval) #false)) 1)
(@test "can-print?#2" "err" (can-print? (make-printer "Brother" 1 (make-ink 0 "red"))) ((submission-eval) ((submission-eval) #false)) 1)
(@test "can-print?#3" "err" (can-print? (make-printer "Dell" 2 (make-ink 100 "black"))) ((submission-eval) ((submission-eval) #true)) 1)
(@test "can-print?#4" "err" (can-print? (make-printer "Canon" 0 (make-ink 0 "red"))) ((submission-eval) ((submission-eval) #false)) 1)
(@test "can-print?#5" "err" (can-print? (make-printer "Xerox" 1 (make-ink 1 "blue"))) ((submission-eval) ((submission-eval) #true)) 1)
