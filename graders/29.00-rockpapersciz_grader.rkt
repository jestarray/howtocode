...
(define ASSIGNMENT-NAME 'rockpapersciz)
...
(@test "rps-tournament#1" "err" (rps-tournament (list "rock") (list "rock")) (list 0) 1)
(@test "rps-tournament#2" "err" (rps-tournament (list "rock") (list "paper")) (list -1) 1)
(@test "rps-tournament#3" "err" (rps-tournament (list "rock") (list "scissors")) (list 1) 1)
(@test "rps-tournament#4" "err" (rps-tournament (list "paper") (list "paper")) (list 0) 1)
(@test "rps-tournament#5" "err" (rps-tournament (list "paper") (list "rock")) (list 1) 1)
(@test "rps-tournament#6" "err" (rps-tournament (list "paper") (list "scissors")) (list -1) 1)
(@test "rps-tournament#7" "err" (rps-tournament (list "scissors") (list "scissors")) (list 0) 1)
(@test "rps-tournament#8" "err" (rps-tournament (list "scissors") (list "rock")) (list -1) 1)
(@test "rps-tournament#9" "err" (rps-tournament (list "scissors") (list "paper")) (list 1) 1)
(@test "rps-tournament#10" "err" (rps-tournament (list "rock" "scissors" "rock")  (list "paper" "paper" "rock")) (list -1 1 0) 1)
        ; (println submission)
        )
(post:
 (add-score-to-report!)
