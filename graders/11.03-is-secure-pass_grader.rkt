...
(define ASSIGNMENT-NAME 'is-secure-pass)
...
(check: :language 'lang/htdp-intermediate
        ...
        (!procedure is-secure-pass? 1)

        ; MAX SCORE SHOULD BE (N / TOTAL-UNIT-TESTS)
        (set-test-max-score! 6)

(@test "pass#1" "err" (is-secure-pass? (make-pin 1423)) #false 1)
(@test "pass#2" "err" (is-secure-pass? (make-pin 12345678901234567890)) #true 1)
(@test "pass#3" "err" (is-secure-pass? (make-pin 123456789012345678901)) #true 1)
(@test "pass#4" "err" (is-secure-pass? (make-text "mypass90ga1")) #false 1)
(@test "pass#5" "err" (is-secure-pass? (make-text "pass90ga122342341312")) #true 1)
(@test "pass#6" "err" (is-secure-pass? (make-text "pass90gaasdfa453tgdf1")) #true 1)
