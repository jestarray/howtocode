...
(define ASSIGNMENT-NAME 'ginventory)
...
(check: :language 'lang/htdp-intermediate
        ...
        (!procedure filter-class 2)

        ; MAX SCORE SHOULD BE (N / TOTAL-UNIT-TESTS)
        (set-test-max-score! 5)

(@test "total-price#0" "err" (total-price empty) 0 1)
(@test "total-price#1" "err" (total-price (list (make-item "sword" "knight" 1 10 3 44) (make-item "staff" "mage" 5 35 5 98))) (+ 44 98) 1)

(@test "filter-class#0" "err" (filter-class empty "knight") empty 1)
(@test "filter-class#1" "err" (filter-class (list (make-item "sword" "knight" 1 10 3 44) (make-item "long sword" "knight" 5 20 10 90) (make-item "wand" "mage" 1 15 3 54) (make-item "staff" "mage" 5 35 5 98)) "knight") ((submission-eval) '(list (make-item "sword" "knight" 1 10 3 44) long-sword)) 1)
(@test "filter-class#2" "err" (filter-class (list (make-item "sword" "knight" 1 10 3 44) (make-item "long sword" "knight" 5 20 10 90) (make-item "wand" "mage" 1 15 3 54) (make-item "staff" "mage" 5 35 5 98)) "mage") ((submission-eval) '(list (make-item "wand" "mage" 1 15 3 54) (make-item "staff" "mage" 5 35 5 98))) 1)
