...
(define ASSIGNMENT-NAME 'teenager)
...
(check: :language 'lang/htdp-intermediate
        ...
        (!procedure is-teenager? 1)

        ; MAX SCORE SHOULD BE (N / TOTAL-UNIT-TESTS)
        (set-test-max-score! 5)

(@test "1" "err" (is-teenager? 11) #false 1)
(@test "1" "err" (is-teenager? 12) #true 1)
(@test "1" "err" (is-teenager? 14) #true 1)
(@test "1" "err" (is-teenager? 16) #true 1)
(@test "1" "err" (is-teenager? 17) #false 1)
