...
(define ASSIGNMENT-NAME 'days-between)
...
(check: :language 'lang/htdp-intermediate
        ...
        (!procedure days-between 6)

        ; MAX SCORE SHOULD BE (N / TOTAL-UNIT-TESTS)
        (set-test-max-score! 5)

(@test "1" "err" (days-between 2022 "January" 1 2022 "January" 4) 3 1)
(@test "2" "err" (days-between 2022 "August" 4 2022 "August" 5) 1 1)
(@test "3" "err" (days-between 2022 "October" 4 2022 "October" 6) 2 1)
(@test "4" "err" (days-between 2022 "October" 1 2022 "October" 31) 30 1)
(@test "5" "err" (days-between 2022 "January" 1 2023 "January" 1) 365 1)
        ; (println submission)
        )
(post:
 (add-score-to-report!)
