...
(define ASSIGNMENT-NAME 'count-members)
...
(@test "count-members#1" "err" (count-members empty empty) 0 1)
(@test "count-members#2" "err" (count-members (list 1 2) empty) 0 1)
(@test "count-members#3" "err" (count-members empty (list 1 2)) 0 1)
(@test "count-members#4" "err" (count-members (list 7 9) (list 9)) 1 1)
(@test "count-members#5" "err" (count-members (list 8 6 9 6 7 8) (list 6 8)) 4 1)
        ; (println submission)
        )
(post:
 (add-score-to-report!)
