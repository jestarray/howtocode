...
(@test "count#1" "err" (count empty 2) 0 1)
(@test "count#2" "err" (count (cons 4 empty) 4) 1 1)
(@test "count#3" "err" (count (cons 9 (cons 9 (cons 7 empty))) 9) 2 1)
(@test "count#4" "err" (count (cons 9 (cons 9 (cons 7 empty))) 7) 1 1)
