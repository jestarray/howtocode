...
(define ASSIGNMENT-NAME 'find-unlisted)
...
(@test "find-unlisted-items#1" "err" (find-unlisted-items empty empty) empty 1)
(@test "find-unlisted-items#2" "err" (find-unlisted-items empty (list "test")) empty 1)
(@test "find-unlisted-items#3" "err" (find-unlisted-items (list "test") empty) (list "test") 1)
(@test "find-unlisted-items#4" "err" (find-unlisted-items (list "test") (list "test")) empty 1)
(@test "find-unlisted-items#5" "err" (find-unlisted-items (list "apple" "bolt" "pear" "wrench") (list "apple" "pear" "banana"))
              (list "bolt" "wrench") 1)
        ; (println submission)
        )
(post:
