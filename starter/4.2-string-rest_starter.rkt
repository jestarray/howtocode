...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 4.2-string-rest_starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|
