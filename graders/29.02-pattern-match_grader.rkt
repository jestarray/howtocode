...
(define ASSIGNMENT-NAME 'pattern-match)
...
(@test "pattern-match?#1" "err" (pattern-match? empty empty) #true 1)
(@test "pattern-match?#2" "err" (pattern-match? empty (list "a")) #true 1)
(@test "pattern-match?#3" "err" (pattern-match? (list "A") empty) #false 1)
(@test "pattern-match?#4" "err" (pattern-match? (list "N") empty) #false 1)
(@test "pattern-match?#5" "err" (pattern-match? (list "A" "N" "A") (list "x" "3" "y")) #true 1)
(@test "pattern-match?#6" "err" (pattern-match? (list "A" "N" "A") (list "1" "3" "y")) #false 1)
(@test "pattern-match?#7" "err" (pattern-match? (list "N" "A" "N") (list "1" "a" "4")) #true 1)
(@test "pattern-match?#8" "err" (pattern-match? (list "N" "A" "N") (list "1" "b" "c")) #false 1)
(@test "pattern-match?#9" "err" (pattern-match? (list "A" "N" "A" "N" "A" "N") (list "V" "6" "T" "1" "Z" "4")) #true 1)
(@test "pattern-match?#10" "err" (pattern-match? (list "A" "N" "A" "N" "A" "N" "A") (list "V" "6" "T" "1" "Z" "4")) #false 1)
        )
(post:
 (add-score-to-report!)
 (write-report)
