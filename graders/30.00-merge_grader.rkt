...
(@test "merge#1" "err" (merge empty empty) empty 1)
(@test "merge#2" "err" (merge empty (list 1 3 5)) (list 1 3 5) 1)
(@test "merge#3" "err" (merge (list 0 2 4) empty) (list 0 2 4) 1)
(@test "merge#4" "err" (merge (list 0 2 4) (list 1 3)) (list 0 1 2 3 4) 1)
        )
(post:
 (add-score-to-report!)
 (write-report)
