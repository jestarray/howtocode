...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 5.01-next-light_starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
